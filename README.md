ត្រូវការអីវ៉ាន់តែអត់មាននៅក្នុងហ្នឹង មានតែរូបអាចឆាតតាមតេឡេក្រាមមកកម្មង់បាន
<html lang="km">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    const allProducts = [
        ...
        { id: 15, name: "ដៃហ្គេម", price: "14.00", img: "IMG_948936274506679.jpeg" },
        { id: 16, name: "Joystick mb03", price: "16.00", img: "IMG_1287990703254651.jpeg" },
        { id: 17, name: "ជើងតម្រើកកុំព្យូទ័រ", price: "14.00", img: "IMG_1418299386133219.jpeg" },
        { id: 18, name: "ដៃហ្គេម trigger ជំនួយទប់លំនឹង (Android&ios)", price: "16.00", img: "IMG_1533019891524636.jpeg" },
        { id: 19, name: "ដុយទូរស័ព្ទ USB in Type-c", price: "14.00", img: "IMG_1609226995025634.jpeg" },
        { id: 20, name: "ដុំភ្ជាប់ជាមួយ keyboard លេងហ្គេមលើទូរស័ព្ទ", price: "16.00", img: "IMG_1638405293831409.jpeg" },
        // ទំព័រទី ៣ (ផលិតផល ២០-៣០) - ចម្លងជួរខាងលើមកដាក់ចុះមកក្រោមបន្តទៀត
        { id: 21, name: "ដុយទូរស័ព្ទ Type-c in Type-c", price: "14.00", img: "IMG_2113856405854556.jpeg" },
        { id: 22, name: "ក្បាលដុយ", price: "16.00", img: "IMG_2174346076711134.jpeg" },
        { id: 23, name: "ជើងតម្រើទូរសព្ទ (ដែក)", price: "14.00", img: "IMG_27299441729644339.jpeg" },
